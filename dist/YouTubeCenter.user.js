...
(function(){
  ...
  var ___main_function = function(injected){
    ...
    var injectingSPF = function(){
      if (ytcenter.spf.isEnabled() && ytcenter.spf.isReadyToInject()) {
